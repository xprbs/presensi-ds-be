...
@section('custom')
    <div class="row">
        @foreach ($students as $class_id => $group)
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title text-capitalize">Siswa {{ $group->first()->classroom->class_name }}
                            {{ $group->first()->classroom->type }} Terdaftar</h4>
                        <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button data-id="{{ $student->nipd }}"
                                                class="detailButton btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                                data-bs-target="#detailModal">Detail</button>
                                            <button data-id="{{ $student->nipd }}"
                                                class="editButton btn btn-sm btn-outline-success" data-bs-toggle="modal"
